    ...
    landing: {
        ...
        hero: {
                ...
                options: [
                    {
                        ...
                        // CHANGED — was: 'Websites built to' / 'convert visitors.'
                        headline: 'Built around what',
                        highlight: 'you need it to do.',

                        // CHANGED — was generic. Now positions against template agencies.
                        description:
                            'Most agencies hand you a template. We start with your goal — more leads, more trust, more revenue — and build backward from there.',
                    },
                    {
                        id: 'dashboard',
                        ...
                        // CHANGED — was: 'Software that saves' / 'hours every week.'
                        headline: 'Less spreadsheet,',
                        highlight: 'more momentum.',

                        // CHANGED — more specific and credible
                        description:
                            'Custom dashboards and internal tools built around how your team actually works — not how a generic SaaS thinks you should.',
                    },
                    {
                        id: 'portal',
                        ...
                        // CHANGED — was: 'Platforms designed for' / 'real operations.'
                        headline: 'Your customers,',
                        highlight: 'your platform.',

                        // CHANGED — sharper
                        description: 'Customer portals and web applications that reflect the quality of your business — built to scale as you do.',
                    },
                ],
            },
            ...
            mobile: {
                ...
                subtitle: 'See what your business could look like. We build websites and apps that bring in customers and make you money.',
                question: 'What do you want to build?',
                prompt: 'Tap one to see\nwhat we can build.',
                chips: [{ label: 'Sell online' }, { label: 'Get more clients' }, { label: 'Automate bookings' }],
                headlines: ['A store that sells', 'More leads,', 'Your calendar,'],
                highlights: ['while you sleep.', 'more revenue.', 'filled on autopilot.'],
                subtitles: [
            ...
            benefits: [
                {
                    ...
                    description: 'Built exactly how you need it - not a generic template',
                },
                {
                    title: 'We Handle Everything',
                    description: "From your idea to launch - you don't need to know tech",
                },
                {
                    title: 'Fast Results',
                    description: 'Get your business online and start getting customers quickly',
                },
            ],
            ctas: {
                primary: 'Get My Free Quote',
                secondary: 'See Examples',
                mobileSecondary: 'See More Examples',
                note: 'Free consultation • No commitment • Quick response time',
            },
            mockups: {
                tabs: ['E-Commerce', 'Analytics Dashboard', 'Booking Platform'],
                descriptions: ['', 'Business intelligence platform', 'Appointment management system'],
                ecommerce: {
                    statusTime: '9:41',
                    storeTitle: 'Store',
                    searchPlaceholder: 'Search products...',
                    featuredLabel: 'Featured',
                    featuredProduct: 'Premium Watch',
                    price: '$299',
                    addToCart: 'Add to Cart',
                    productCountLabel: '4 products',
                },
                analytics: {
                    browserUrl: 'analytics.yourapp.com',
        ...
        faq: {
            ...
            items: [
                ...
                },
                {
                    ...
                    answer: 'Absolutely. We can adapt to an existing brand, refine a Figma file, or build a visual direction from scratch if needed.',
                },
                {
