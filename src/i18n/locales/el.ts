...
export const el: Translations = {
  contact: {
    ...
    messagePlaceholder:
        'Πείτε μου λίγα λόγια για το project σας, τι χρειάζεστε και πότε θέλετε να ξεκινήσει...',
    ...
    trustNote:
        'Καθαρό scope, ειλικρινή χρονοδιαγράμματα και άμεση συνεργασία από την πρώτη μέρα.',
    errorFixFields: 'Παρακαλώ διορθώστε τα παρακάτω σφάλματα.',
    errorGeneric:
        'Κάτι πήγε στραβά. Παρακαλώ δοκιμάστε ξανά ή επικοινωνήστε μέσω email.',
  ...
  testimonials: {
    ...
    items: [
      ...
      },
      {
        ...
        content:
            'Επαγγελματίες, αποδοτικοί και με υψηλή τεχνογνωσία. Μετέτρεψαν το παλιό μας σύστημα σε μια σύγχρονη responsive εφαρμογή.',
      },
    ],
  },
  ...
  landing: {
    seo: {
      ...
      description:
          'Ένα σύγχρονο website για υπηρεσίες web development, βασισμένο στη σαφήνεια, την εμπιστοσύνη και την πρόοδο.',
    },
    hero: {
      navigation: {
        brandInitial: 'C',
      ...
      benefits: [
        {
          ...
          description:
              'Κατασκευασμένο ακριβώς όπως το χρειάζεστε - όχι ένα γενικό template',
        },
        {
          title: 'Αναλαμβάνουμε τα Πάντα',
          description:
              'Από την ιδέα μέχρι το launch - δεν χρειάζεται να γνωρίζετε τεχνολογία',
        },
        {
          title: 'Γρήγορα Αποτελέσματα',
          description:
              'Βγείτε online γρήγορα και ξεκινήστε να αποκτάτε πελάτες',
        },
      ],
      ...
      items: [
        {
          ...
          description:
              'Γρήγορα και καλαίσθητα websites για επιχειρήσεις που χρειάζονται ισχυρή online παρουσία.',
          features: [
            'Responsive Design',
            'SEO Optimization',
            'Γρήγορη Φόρτωση',
        ...
        },
        {
          title: 'Web Εφαρμογές',
          description:
              'Διαδραστικές εφαρμογές με business logic προσαρμοσμένο στις ανάγκες σας.',
          features: [
            'Όλα όσα περιλαμβάνονται στα Static Websites',
            'Custom Features',
            'Σύστημα Χρηστών',
            'API Integration (Προαιρετικό)',
          ],
    ...
    process: {
      ...
      description:
          'Κρατάμε τη δουλειά οργανωμένη και τις αποφάσεις ξεκάθαρες ώστε το project να προχωρά χωρίς χάος.',
      steps: [
        {
          title: 'Σχεδιασμός & Κατανόηση',
          description:
              'Καθορίζουμε στόχους, απαιτήσεις και κοινό πριν ξεκινήσει οποιοδήποτε design ή development.',
        },
        {
          title: 'Design & Αρχιτεκτονική',
          description:
              'Σχεδιάζουμε το interface και την τεχνική προσέγγιση ώστε το αποτέλεσμα να είναι λειτουργικό και επεκτάσιμο.',
        },
        {
          title: 'Ανάπτυξη & Testing',
          description:
              'Η ανάπτυξη γίνεται σε οργανωμένα στάδια με testing και feedback σε κάθε βήμα.',
        },
        {
          title: 'Launch & Υποστήριξη',
          description:
              'Κάνουμε deploy, παρακολουθούμε το project και παρέχουμε υποστήριξη μετά το launch.',
        },
      ],
    },
    ...
    faq: {
      ...
      description:
          'Απαντήσεις στις πιο συχνές απορίες ώστε να υπάρχει ξεκάθαρη εικόνα πριν ξεκινήσουμε.',
      items: [
        {
          question: 'Πόσο διαρκεί συνήθως ένα project;',
          answer:
              'Μικρότερα websites χρειάζονται περίπου 2 έως 4 εβδομάδες, ενώ μεγαλύτερες εφαρμογές μπορεί να χρειαστούν 8 έως 16 εβδομάδες ανάλογα με το scope.',
        },
        {
          question: 'Αναλαμβάνετε hosting και deployment;',
          answer:
              'Ναι. Μπορούμε να κάνουμε deploy σε σύγχρονες cloud πλατφόρμες και να σας βοηθήσουμε να επιλέξετε την κατάλληλη υποδομή.',
        },
        {
          question: 'Προσφέρετε υποστήριξη μετά το launch;',
          answer:
              'Ναι. Παρέχουμε υποστήριξη, βελτιώσεις, ενημερώσεις ασφαλείας και monitoring μετά την κυκλοφορία.',
        },
      ],
    },
    // @ts-expect-error Will be fixed in the future, we don't support el yet.
    footer: {
      brandName: 'CodeGetIt',
      tagline:
          'Δημιουργούμε σύγχρονες web εμπειρίες που βοηθούν τις επιχειρήσεις να αναπτυχθούν online.',
      categories: {
        services: 'Υπηρεσίες',
        company: 'Εταιρεία',
        resources: 'Πόροι',
