    ...
    <div className="rounded-[2rem] border border-gray-200 bg-linear-to-br from-white via-white to-slate-50 p-6 shadow-sm">
        <div className="flex flex-wrap items-start justify-between gap-6">
            <div className="max-w-3xl">
                <p className="text-sm font-medium uppercase tracking-[0.16em] text-gray-500">{copy.eyebrow}</p>
          ...
          <span className="inline-flex items-center gap-1.5 rounded-full bg-slate-900 px-3 py-1.5 text-xs font-medium text-white">
            ...
            {dirtyCount > 0 ? <CircleAlert className="h-3.5 w-3.5 text-amber-600" /> : <CircleCheck className="h-3.5 w-3.5 text-emerald-600" />}
            ...
            <div className="flex w-full max-w-xl flex-col gap-3">
                <label className="relative">
                    ...
                    <input
                        ...
                        className="w-full rounded-2xl border border-gray-200 bg-white py-3 pl-11 pr-4 text-sm text-gray-900 shadow-sm outline-none transition focus:border-gray-300 focus:ring-4 focus:ring-gray-100"
                    />
                </label>
