    ...
    <section id="about" className="py-32 lg:py-40 bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <motion.div
          ...
          className="mb-24"
        >
          <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-4">About</p>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-32 py-16 border-y border-gray-200"
        >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="mt-32 bg-gray-950 rounded-2xl p-10 md:p-16"
        >
          <p className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-4">Performance</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
            {[
              { metric: '99.9%', label: 'Uptime average', desc: 'Production-grade reliability' },
              { metric: '<200ms', label: 'Response time', desc: 'Optimized for performance' },
              { metric: '2–4 wks', label: 'Time to launch', desc: 'From concept to production' },
            ].map((item, i) => (
              <div key={i}>
