...
export const ContactSidebar = ({
  ...
  <motion.div
    ...
    className={className}
  >
    <div className="sticky top-32 space-y-10 overflow-hidden rounded-3xl border border-gray-800 bg-linear-to-b from-gray-950 via-slate-900 to-gray-950 p-8 text-gray-100 shadow-2xl shadow-slate-900/30 relative">
      <motion.div
      ...
      <div>
        <p className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">{emailLabel}</p>
        <a
          href={`mailto:${email}`}
      ...
      <div>
        <p className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">{locationLabel}</p>
        <p className="text-lg text-white">{locationValue}</p>
      </div>

      <div>
        <p className="mb-3 text-sm font-medium uppercase tracking-wider text-gray-400">{responseTimeLabel}</p>
