...
function HeroProjectLayout({ project, color, isInView }: {
  project: Project;
  color: string;
  isInView: boolean;
}) {
      ...
      <div className="mt-14 grid gap-10 lg:grid-cols-[1fr_420px] lg:items-center">
        ...
        >
          ...
          <img
              src={project.logo}
              alt={project.title}
              className="absolute inset-0 h-full w-full scale-105 object-cover opacity-90 blur-sm transition-all duration-700 group-hover:scale-100 group-hover:opacity-50 group-hover:blur-0"
          />
          ...
          <div className="absolute right-5 top-5 flex items-center gap-1.5 rounded-full border border-white/20 bg-white/10 px-3 py-1.5 backdrop-blur-sm">
            ...
            <span className="text-xs font-medium uppercase tracking-wide text-white/70">Live</span>
          </div>
        ...
        >
          ...
          {/* Title */}
          <h2 className="font-serif text-5xl font-bold leading-[1.1] text-white lg:text-6xl">
            {project.title}
          </h2>
          ...
          <div className="flex flex-col gap-3 pt-2">
            <a
                ...
                style={{ color }}
            >
            <span className="border-b border-current pb-0.5 transition-all group-hover/cta:pb-1">
              Explore the Project
            </span>
