        ...
        >
          ...
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 md:hidden">
            ...
            <div className="grid grid-cols-[1fr_90px_100px] border-b border-white/10 bg-white/5">
              <div className="px-4 py-3 text-xs font-semibold uppercase tracking-[0.15em] text-slate-400 flex items-center">
                  {comparison.headers.feature}
              </div>

              <div className="flex items-center justify-center px-2 py-3 text-center text-[10px] font-semibold uppercase tracking-[0.12em] text-slate-300">
                {comparison.headers.staticWebsite}
              </div>

              <div className="flex items-center justify-center bg-cyan-400/10 px-2 py-3 text-center text-[10px] font-semibold uppercase tracking-[0.12em] text-cyan-200">
                {comparison.headers.fullStackApplication}
              </div>
            </div>
            ...
            {comparison.rows.map((rowLabel, index) => {
              ...
              return (
                  <div key={rowLabel} className="grid grid-cols-[1fr_90px_100px] border-b border-white/5 last:border-none">
                    {/* Feature */}
                    <div className="px-4 py-4 text-sm leading-relaxed text-white">
                      {rowLabel}
                    </div>
                    ...
                    <div className="flex items-center justify-center bg-cyan-400/5 px-2">
                      {typeof row.fullStack === 'boolean' ? (
                          ...
                          <span className="text-center text-xs font-medium text-cyan-300">
                            {row.fullStack}
                          </span>
                      )}
                    </div>
